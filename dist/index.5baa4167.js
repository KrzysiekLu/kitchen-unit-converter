...
var _keyJson = require("./key.json");
var _keyJsonDefault = parcelHelpers.interopDefault(_keyJson);
"use strict";
// form
...
const optionsIngredients = {
    method: "GET",
    headers: {
        "X-RapidAPI-Key": `${(0, _keyJsonDefault.default).apiKey}`,
...
const convert = async ()=>{
    ...
    await fetch(` https://food-unit-of-measurement-converter.p.rapidapi.com/convert?unit=${entryUnit}&ingredient=${entryName}&value=${entryAmount}`, options).then((response)=>response.json()).then((response)=>{
...
console.log((0, _keyJsonDefault.default).apiKey);

},{"./key.json":"dI3L1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dI3L1":[function(require,module,exports) {
module.exports = JSON.parse('{"apiKey":"90ac66de72msh0702568874e9e64p1f5620jsn9038c1bf31c6"}');
...
},{}]},["euTuy","igcvL"], "igcvL", "parcelRequire9778")
